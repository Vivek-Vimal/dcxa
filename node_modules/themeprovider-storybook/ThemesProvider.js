...
exports.ThemesProvider = function (_a) {
    ...
    if (CustomThemeProvider) {
        if (!theme && story)
            return React.createElement(CustomThemeProvider, { theme: themes.first() }, children);
        return React.createElement(CustomThemeProvider, { theme: theme }, children);
    }
    if (!theme && story)
        return React.createElement(styled_components_1.ThemeProvider, { theme: themes.first() }, children);
