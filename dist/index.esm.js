...
var Icon$q = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React.createElement("image", { width: "20", height: "20", href: isDark ? "/images/Logo.png" : "/images/Logo.png" })));
};
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null, cakePriceUsd ? (React.createElement(PriceLink, null,
            ...
            " ",
            React.createElement(Text, { style: { margin: '0 0 0 2rem' }, fontSize: '1.4rem', color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
